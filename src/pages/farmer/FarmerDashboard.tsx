      ...
      {activeTab === "products" && (
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-xl border border-border p-8 text-center">
            <Wheat className="w-12 h-12 mx-auto mb-3 text-muted-foreground" />
            <p className="text-muted-foreground">Product management panel — list, edit, and manage your produce inventory here.</p>
          </div>
        </div>
      )}
